...
const AccountManager = () => {
    ...
    const [employeeidcreateStatus, setEmployeeidCreateStatus] = useState("disable");
                ...
                <div className="space-y-4">
                    ...
                    <div className="lg:w-100 md:w-100 flex flex-wrap gap-4">
                        ...
                        <div className="flex items-center gap-2" >
                            <RadioButton inputId="employeeidcreateOption1" name="employeeidcreateredio" value="enable" onChange={handleChangeEmployeeidCreateStatus} checked={employeeidcreateStatus === 'enable'} />
                            <label htmlFor="employeeidcreateOption1" className="text-gray-700 font-medium text-sm cursor-pointer">Active</label>
                        </div>
                        {/* Option 2 */}
                        <div className="flex items-center gap-2" >
                            <RadioButton inputId="employeeidcreateOption2" name="employeeidcreateredio" value="disable" onChange={handleChangeEmployeeidCreateStatus} checked={employeeidcreateStatus === 'disable'} />
                            <label htmlFor="employeeidcreateOption2" className="text-gray-700 font-medium text-sm cursor-pointer">Inactive</label>
                        </div>
                    </div>
