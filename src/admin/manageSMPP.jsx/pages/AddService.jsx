                        ...
                        <div className="flex flex-col">
                           ...
                           <div className='flex gap-4 mt-3'>
                             ...
                             <div className="flex items-center gap-2" >
                                <RadioButton inputId="versionaddOption1" name="versionaddredio" value="enable" onChange={handleChangeVersionAddStatus} checked={versionaddStatus === 'enable'} />
                                <label htmlFor="versionaddOption1" className="text-gray-700 font-medium text-sm cursor-pointer">3.3</label>
                            </div>
                            {/* Option 2 */}
                            <div className="flex items-center gap-2" >
                                <RadioButton inputId="versionaddOption2" name="versionaddredio" value="disable" onChange={handleChangeVersionAddStatus} checked={versionaddStatus === 'disable'} />
                                <label htmlFor="versionaddOption2" className="text-gray-700 font-medium text-sm cursor-pointer">3.4</label>
                            </div>
                           </div>
                        </div>
                        ...
                        />
                         <div className="flex flex-col">
                           ...
                           <div className='flex gap-4 mt-3'>
                             {/* Option 1 */}
                             <div className="flex items-center gap-2" >
                                <RadioButton inputId="tpaddOption1" name="tpaddredio" value="enable" onChange={handleChangetpAddStatus} checked={tpaddStatus === 'enable'} />
                                <label htmlFor="tpaddOption1" className="text-gray-700 font-medium text-sm cursor-pointer">Yes</label>
                            </div>
                            {/* Option 2 */}
                            <div className="flex items-center gap-2" >
                                <RadioButton inputId="tpaddOption2" name="tpaddredio" value="disable" onChange={handleChangetpAddStatus} checked={tpaddStatus === 'disable'} />
                                <label htmlFor="tpaddOption2" className="text-gray-700 font-medium text-sm cursor-pointer">No</label>
                            </div>
                           </div>
                        </div>
                        {tpaddStatus === "enable" && (
