...
const ManageSMPPTable = ({ id, name }) => {
    ...
    const columns = [
        ...
        { field: "servicename", headerName: "Service Name", flex: 1, minWidth: 130 },
        { field: "username", headerName: "User Name", flex: 1, minWidth: 120 },
        { field: "host", headerName: "Host", flex: 1, minWidth: 120 },
        { field: "sendingport", headerName: "Sending Port", flex: 1, minWidth: 120 },
        { field: "receiverport", headerName: "Receiver Port", flex: 1, minWidth: 120 },
        { field: "sockets", headerName: "Sockets", flex: 1, minWidth: 60 },
        { field: "connectivity", headerName: "Connectivity", flex: 1, minWidth: 120 },
                        ...
                        <div className="flex flex-col">
                           ...
                           <div className='flex gap-4 mt-3'>
                             ...
                             <div className="flex items-center gap-2" >
                                <RadioButton inputId="versioneditOption1" name="versioneditredio" value="enable" onChange={handleChangeVersionEditStatus} checked={versioneditStatus === 'enable'} />
                                <label htmlFor="versioneditOption1" className="text-gray-700 font-medium text-sm cursor-pointer">3.3</label>
                            </div>
                            {/* Option 2 */}
                            <div className="flex items-center gap-2" >
                                <RadioButton inputId="versioneditOption2" name="versioneditredio" value="disable" onChange={handleChangeVersionEditStatus} checked={versioneditStatus === 'disable'} />
                                <label htmlFor="versioneditOption2" className="text-gray-700 font-medium text-sm cursor-pointer">3.4</label>
                            </div>
                           </div>
                        </div>
                        ...
                        />
                         <div className="flex flex-col">
                           ...
                           <div className='flex gap-4 mt-3'>
                             {/* Option 1 */}
                             <div className="flex items-center gap-2" >
                                <RadioButton inputId="tpeditOption1" name="tpeditredio" value="enable" onChange={handleChangetpEditStatus} checked={tpeditStatus === 'enable'} />
                                <label htmlFor="tpeditOption1" className="text-gray-700 font-medium text-sm cursor-pointer">Yes</label>
                            </div>
                            {/* Option 2 */}
                            <div className="flex items-center gap-2" >
                                <RadioButton inputId="tpeditOption2" name="tpeditredio" value="disable" onChange={handleChangetpEditStatus} checked={tpeditStatus === 'disable'} />
                                <label htmlFor="tpeditOption2" className="text-gray-700 font-medium text-sm cursor-pointer">No</label>
                            </div>
                           </div>
                        </div>
                        {tpeditStatus === "enable" && (
