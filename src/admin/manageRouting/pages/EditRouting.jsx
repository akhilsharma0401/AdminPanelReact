...
const EditRouting = ({ id, name }) => {
    ...
    const [editroutingheaderStatus, setEditRoutingHeaderStatus] = useState("disable");
    const [editroutingmobileStatus, setEditRoutingMobileStatus] = useState("disable");
    const [editroutingoperatorsStatus, setEditRoutingOperatorsStatus] = useState("disable");
    ...
    const columns = [
        ...
        { field: "sendingservice", headerName: "Sending Service", flex: 1, minWidth: 120 },
        { field: "userserialno", headerName: "User Serial No", flex: 1, minWidth: 120 },
        { field: "senderid", headerName: "Sender ID", flex: 1, minWidth: 120 },
        { field: "holdingtime", headerName: "Holding Time", flex: 1, minWidth: 120 },
        { field: "routingstatus", headerName: "Routing Status", flex: 1, minWidth: 120 },
