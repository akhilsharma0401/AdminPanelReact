...
const AddRouting = ({ id, name }) => {
    ...
    const [addroutingheaderStatus, setAddRoutingHeaderStatus] = useState("disable");
    const [addroutingmobileStatus, setAddRoutingMobileStatus] = useState("disable");
    const [addroutingoperatorsStatus, setAddRoutingOperatorsStatus] = useState("disable");
